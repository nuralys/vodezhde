...
<div class="input select">
	<label for="ProductParentId">Категория:</label>
...
<input type="text" name="data[Product][imgsource2]" class="imgsource2" value="" />
<input type="text" name="data[Product][imgcrop2]" class="imgcrop2" value="" />
<?php
